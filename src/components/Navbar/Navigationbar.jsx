        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <NavLink
                to="/"
                className="text-decoration-none fs-4 mx-3 text-black fw-semibold item"
              >
                Home
              </NavLink>
              <NavLink
              ...
              {user?.email ? (
                <div className="d-lg-flex justify-content-between flex-column flex-lg-row">
                  ...
                  <div className="text-decoration-none fs-4 mx-3 text-black fw-semibold item">
                    <Button
                      className="btn-light fs-5 fw-semibold"
                ...
                <div>
                  <NavLink
                    className="text-decoration-none mx-3 fs-4 text-black fw-semibold item"
                    to="/login"
                  >
                    Login
                  </NavLink>
